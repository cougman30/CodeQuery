...
{
    public partial class AddedIsActiveToPostModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropForeignKey(name: "FK_Label_Post_PostID", table: "Label");
            ...
            migrationBuilder.DropColumn(name: "PostID", table: "Label");
